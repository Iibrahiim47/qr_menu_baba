...
class KoutDetailPage extends StatefulWidget {
  Data model;

  KoutDetailPage({super.key, required this.model});

  @override
  State<KoutDetailPage> createState() => _KoutDetailPageState();
}

class _KoutDetailPageState extends State<KoutDetailPage> {
  @override
  void initState() {
    super.initState();
  }
